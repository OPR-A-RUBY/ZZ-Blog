...
____ 12. Создадим ещё метод CREATE в контроллере (по типу new)

    def create
    end

____ 13. Добавим файл представления create.html.erb в папку:
# app/views/zamets/ 
# добавим в него такой код <h3>CREATE</h3> для теста

# Теперь можно ввести в форму данные (любые) и нажать кнопку

(lissson-37, time => 1:38:30)