1. Устанавливаем Rais
# gem install rails

2. Переходим в папку, где будет создаваться папка с нашим приложением внутри. И вводим команду создания нового приложенеия на RAILS
# rails new ZZ-Blog
...
3. Дальше смотрим, на запус RAILS т.е. вводим коменду:
# rails server
...
4.1. На сайте создаём пустой репозиторий с именем, как имя главной папки нашего приложения.

4.2. Далее запускаем в терминале, открытом внутри основной папки приложения 
...
5. Создаём контроллер Home # index
